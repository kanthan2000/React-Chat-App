...
function App() {
  ...
  return (
    <div className="px-8 flex items-center justify-center text-white  bg-no-repeat bg-cover w-full h-screen" style={{backgroundColor:"rgb(65 63 59)"}}>
      {!showChat ? (
        <div className="w-fit flex flex-col justify-center items-center text-center space-y-2 bg-white/10 backdrop-blur-sm rounded-xl py-8 px-4">
          <h1 className="text-3xl font-bold">Welcome to Group Chat App</h1>
          <input
            type="text"
